...
def get_args():
    ...
    args.correctness_file=f"correctness/correctness_file_{args.model_type}.txt"
    ...
    if len(args.api_key) < 10 and 'OPENAI_API_KEY' in os.environ:
...
def append_jsonl(content, file_path):
    if not file_path.endswith(".jsonl"):
        print("The file path for function append_jsonl should end with .jsonl")
    with open(file_path, "a") as f:
        f.write(content + "\n")
...
def test_on_benchmark(args):
    ...
    generated_code_dir = f"{args.model_name}_generated_code_{args.model_type}"
    ...
    for benchmark in benchmarks:
        ...
        if not args.eval_only:
            ...
            for design_dir in tqdm(design_dir_list):
                ...
                for i in range(args.n4pass_at_k):
        ...
        if not args.gen_only:
            ...
            result_path_jsonl = os.path.join(args.result_path, f"{args.model_name}_{benchmark}_{args.timetag}.jsonl")
